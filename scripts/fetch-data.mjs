#!/usr/bin/env node
/**
 * Descarga los CSV de SInCA (datos.cultura.gob.ar) y el GeoJSON de provincias
 * de Georef (apis.datos.gob.ar) a /data/raw. Si no hay acceso de red a esos
 * dominios, no inventa nada: falla con instrucciones para colocar los
 * archivos manualmente.
 */
import { mkdir, writeFile } from 'node:fs/promises'
import path from 'node:path'
import { fileURLToPath } from 'node:url'
import { SINCA_RESOURCES, GEOREF_PROVINCIAS_URL } from './lib/sinca-sources.mjs'
